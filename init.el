...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smartparens company-jedi function-args evil-magit magit aggressive-indent markdown-mode srefactor ivy-rtags flycheck-rtags irony-mode electric-pair-mode use-package company-irony-c-headers cmake-mode flycheck-irony flycheck spacemacs-theme rtags cmake-ide company-irony irony company doom-themes rainbow-delimiters evil smex ivy))))
(custom-set-faces
